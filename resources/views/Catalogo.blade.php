                    ...
                    <div class="cardlalo" style="width: 18rem;">
                        ...
                        <div class="card-body">
                         ...
                         <h6 class="card-subtitle mb-2 text-muted">{{$product->costo}}</h6>
                          ...
                          <a href="https://api.whatsapp.com/send?phone=+5219983942633"  class="btn btn-warning">WhatsApp</a>
                        </div>
                        <a class="btn btn-secondary" href="<?php echo action('HomeController@show') ?>">Agendar cita</a>
                      </div>
